@extends("layouts.BE.master", ["breadcrumb" => ["Home", "Slider"]])
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <div class="flex gap-1">
                        <button type="button" class="btn btn-primary btn-label" onclick="openForm('{{url('/admin/slider/create')}}', 'create', 'lg')">
                            <div class="d-flex">
...
@push('scripts')
    <script>
        var dt;
        var API_URL = "{{ url('/admin/slider/api') }}";
