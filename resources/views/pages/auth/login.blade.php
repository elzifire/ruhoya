...
<body class="auth-bg 100-vh">
                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100 py-0 py-xl-4">
                                ...
                                <div class="text-center mb-5">
                                    <a href="index.html">
                                        <span class="logo-lg">
                                            <img src="{{ asset('FE/images/ruhoya-logo.png') }}" alt=""
                                                height="50">
                                        </span>
                                    </a>
                                </div>
                                                    ...
                                                    <form onsubmit="return false;" class="auth-input" data-login-form>
                                                        ...
                                                        <div class="form-check form-check-primary fs-16 py-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="remember_me" id="remember-check">
                                                        ...
                                                        <div class="mt-2">
                                                            <button class="btn btn-primary w-100" type="submit"
                                                                data-submit-btn>Masuk</button>
                                                        </div>
                                                        <div class="mt-2">
                                                            <a href="{{ url('/forgot-password') }}"
                                                                class="text-muted text-center">Lupa password?</a>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
    ...
    <!-- password-addon init -->
    <script src="{{ asset('assets/BE/js/pages/password-addon.init.js') }}"></script>
    <script>
